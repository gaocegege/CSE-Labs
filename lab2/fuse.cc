...
// symlink: the function to create the soft link
// link is the path, name is the link's name
// fuse_reply_entry: unknown
void
...
// readlink: read the name's content, and use fuse_reply_readlink
void
